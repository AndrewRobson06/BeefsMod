...
{
    public class NaniteArrow : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.knockBack = 1.5f;
            Item.value = Item.sellPrice(silver: 3, copper: 1);
            Item.rare = ItemRarityID.Orange;
            Item.shoot = ModContent.ProjectileType<NaniteArrowProjectile>(); // The projectile that weapons fire when using this item as ammunition.
        ...
        {
            CreateRecipe(35)
                .AddIngredient(ItemID.WoodenArrow, 35)
