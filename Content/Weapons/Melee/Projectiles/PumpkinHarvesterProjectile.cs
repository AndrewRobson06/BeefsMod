...
{
    public class PumpkinHarvesterProjectile : ModProjectile
    {
        ...
        public override string Texture => "BeefsMod/Content/Weapons/Melee/PumpkinHarvester"; // Use texture of item as projectile texture
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.instance.LoadProjectile(997);
            Texture2D EffectTex = TextureAssets.Projectile[997].Value;
            ...
            //Main.EntitySpriteDraw(EffectTex, Projectile.Center - Main.screenPosition, default, lightColor * Projectile.Opacity, Projectile.rotation + rotationOffset, origin, Projectile.scale, effects, 0);
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            //Main.spriteBatch.Draw(bloomTex, Projectile.Center - new Vector2(0, 0).RotatedBy(0) - Main.screenPosition,
                   //null, new Color(255, 179, 0, 50), 0, bloomTex.Size() / 2f, 6f, 0f, 0f);
        }
        ...
        public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
        {
            ...
            //Dust.NewDust(new Vector2(projHitbox.X, projHitbox.Y), projHitbox.Width, projHitbox.Height, DustID.Torch);
        ...
        {
            ParticleOrchestrator.RequestParticleSpawn(clientOnly: false, ParticleOrchestraType.WallOfFleshGoatMountFlames,
