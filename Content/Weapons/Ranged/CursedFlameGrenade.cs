...
{
    internal class CursedFlameGrenade : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<CursedFlameGrenadeProjectile>();
            Item.shootSpeed = 12f;
    ...
    public class CursedFlameGrenadeProjectile : ModProjectile
    {
        int deathTimer;
        public override string Texture => "BeefsMod/Content/Weapons/Ranged/CursedFlameGrenade";
        ...
        public override void AI()
        {
            if (deathTimer > 0)
            {
                ...
                Dust.NewDustPerfect(Projectile.Center + new Vector2(-5, -5).RotatedBy(Projectile.rotation), DustID.CursedTorch, Vector2.Zero, 0, default, 1.5f).noGravity = true;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (deathTimer > 0)
            {
                ...
                Main.spriteBatch.Draw(starTex, Projectile.Center - new Vector2(5, 5).RotatedBy(Projectile.rotation) - Main.screenPosition,
                    null, new Color(55, 200, 26, 255) * fade, Projectile.rotation, starTex.Size() / 2f, 1f, 0f, 0f);

                Main.spriteBatch.Draw(starTex, Projectile.Center - new Vector2(5, 5).RotatedBy(Projectile.rotation) - Main.screenPosition,
                    null, new Color(22, 136, 119, 255) * fade, Projectile.rotation, starTex.Size() / 2f, 0.5f, 0f, 0f);

                Main.spriteBatch.Draw(bloomTex, Projectile.Center - new Vector2(5, 5).RotatedBy(Projectile.rotation) - Main.screenPosition,
                    null, new Color(39, 117, 117, 255) * fade * 0.35f, Projectile.rotation, bloomTex.Size() / 2f, 0.75f, 0f, 0f);

                Main.spriteBatch.Draw(bloomTex, Projectile.Center - new Vector2(5, 5).RotatedBy(Projectile.rotation) - Main.screenPosition,
                    null, new Color(249, 255, 211, 255) * fade * 0.4f, Projectile.rotation, bloomTex.Size() / 2f, 1f, 0f, 0f);
        ...
        internal void Explode()
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<CursedFlameGrenadeExplosion>(),
    ...
    public class CursedFlameGrenadeExplosion : ModProjectile
    {
        public override string Texture => "BeefsMod/Content/Weapons/Ranged/CursedFlameGrenade";
        ...
        public override void AI()
        {
            for (int k = 0; k < 6; k++)
            {
                ...
                Dust.NewDustPerfect(Projectile.Center + Vector2.One.RotatedBy(rot) * Radius, DustID.CursedTorch,
