...
{
    internal class CrystalGrenade : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<CrystalGrenadeProjectile>();
            Item.shootSpeed = 12f;
    ...
    public class CrystalGrenadeProjectile : ModProjectile
    {
        int deathTimer;
        public override string Texture => "BeefsMod/Content/Weapons/Ranged/CrystalGrenade";
        ...
        public override void AI()
        {
            if (deathTimer > 0)
            {
                ...
                Dust.NewDustPerfect(Projectile.Center + new Vector2(-5, -5).RotatedBy(Projectile.rotation), DustID.PinkTorch, Vector2.Zero, 0, default, 0.75f).noGravity = true;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (deathTimer > 0)
            {
                ...
                Main.spriteBatch.Draw(starTex, Projectile.Center - new Vector2(5, 5).RotatedBy(Projectile.rotation) - Main.screenPosition,
                    null, new Color(255, 0, 210, 145) * fade, Projectile.rotation, starTex.Size() / 2f, 1f, 0f, 0f);

                Main.spriteBatch.Draw(starTex, Projectile.Center - new Vector2(5, 5).RotatedBy(Projectile.rotation) - Main.screenPosition,
                    null, new Color(0, 40, 86, 255) * fade, Projectile.rotation, starTex.Size() / 2f, 0.5f, 0f, 0f);

                Main.spriteBatch.Draw(bloomTex, Projectile.Center - new Vector2(5, 5).RotatedBy(Projectile.rotation) - Main.screenPosition,
                    null, new Color(95, 205, 228, 255) * fade * 0.35f, Projectile.rotation, bloomTex.Size() / 2f, 0.75f, 0f, 0f);

                Main.spriteBatch.Draw(bloomTex, Projectile.Center - new Vector2(5, 5).RotatedBy(Projectile.rotation) - Main.screenPosition,
                    null, new Color(47, 0, 86, 255) * fade * 0.4f, Projectile.rotation, bloomTex.Size() / 2f, 1f, 0f, 0f);
        ...
        internal void Explode()
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<CrystalGrenadeExplosion>(),
                    Projectile.damage + 25, Projectile.knockBack * 1.5f, Projectile.owner, 100);
            }
        ...
        internal void SparkleExplode()
        {

            SoundEngine.PlaySound(SoundID.Item110 with { Volume = 1f }, Projectile.Center);

            if (Main.myPlayer == Projectile.owner)
            {
                Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<CrystalGrenadeSparkle>(),
                    Projectile.damage - 15, Projectile.knockBack * 1.5f, Projectile.owner, 120);
            }

        }

        public class CrystalGrenadeExplosion : ModProjectile
        {
            public override string Texture => "BeefsMod/Content/Weapons/Ranged/CrystalGrenade";
            ...
            public override void AI()
            {
                for (int k = 0; k < 8; k++)
                {
                    ...
                    Dust.NewDustPerfect(Projectile.Center + Vector2.One.RotatedBy(rot) * Radius, DustID.PinkTorch,
                        Vector2.One.RotatedBy(rot) * 0.5f, 0, default, Main.rand.NextFloat(3f, 4f)).noGravity = true;

                    Dust.NewDustPerfect(Projectile.Center + Vector2.One.RotatedBy(rot) * Radius, DustID.PurpleTorch,
                    ...
                    Dust.NewDustPerfect(Projectile.Center + Vector2.One.RotatedBy(rot) * Radius, DustID.BlueTorch,
                        Vector2.One.RotatedBy(rot) * 0.5f, 0, default, Main.rand.NextFloat(1f, 1.5f)).noGravity = true;
                }
            }
        ...
        public class CrystalGrenadeSparkle : ModProjectile
        {
            public override string Texture => "BeefsMod/Content/Weapons/Ranged/CrystalGrenade";
            ...
            public override void AI()
            {
                for (int k = 0; k < 14; k++)
                {
                    ...
                    Dust.NewDustPerfect(Projectile.Center + Vector2.One.RotatedBy(rot) * Radius, DustID.PinkCrystalShard,
                        Vector2.One.RotatedBy(rot) * 0.5f, 0, default, Main.rand.NextFloat(2f, 2.5f)).noGravity = true;

                    Dust.NewDustPerfect(Projectile.Center + Vector2.One.RotatedBy(rot) * Radius, DustID.PurpleCrystalShard,
                        Vector2.One.RotatedBy(rot) * 0.5f + Main.rand.NextVector2Circular(1.75f, 2f), 50, default, Main.rand.NextFloat(0.5f, 1f));

                    Dust.NewDustPerfect(Projectile.Center + Vector2.One.RotatedBy(rot) * Radius, DustID.BlueCrystalShard,
                        Vector2.One.RotatedBy(rot) * 0.5f, 0, default, Main.rand.NextFloat(1.5f, 1.75f)).noGravity = true;
                }
            }
