...
namespace BeefsMod.Content.Items.Tools.Projectiles
{
    public class ScarabiteDrillProjectile : ModProjectile
    {
        public override void SetDefaults()
        {
            ...
            //Projectile.drawLayer = ProjectileDrawLayerID.HeldProj; // Draws over the player's body and under the player's hand
        }
        ...
        public override void AI()
        {
            ...
            {
                Dust dust = Dust.NewDustDirect(Projectile.position + Projectile.velocity * Main.rand.Next(6, 10) * 0.15f, Projectile.width, Projectile.height, DustID.BoneTorch, 0f, 0f, 80, default, 1f);
                dust.position.X -= 4f;
                dust.noGravity = true;
