...
{
    public class OverclockedBallistaArrow : ModProjectile
    {
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                Vector2 velocity = Vector2.One.RotatedByRandom(MathHelper.TwoPi * (i / 2f));

                Dust.NewDustPerfect(Projectile.Center, DustID.GlowingMushroom, velocity * 2f, 0, default, 1f).noGravity = true;
            }
