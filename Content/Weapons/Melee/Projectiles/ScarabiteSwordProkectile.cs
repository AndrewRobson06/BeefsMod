...
namespace BeefsMod.Content.Weapons.Melee.Projectiles
{
    public class ScarabiteSwordProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            float scaleAdder = 1.1f; // Excalibur, Terra Blade, and The Horseman's Blade is 1f; True Excalibur is 1.2f; default is 1f
            ...
            if (Main.rand.NextFloat() * 2f < Projectile.Opacity)
            {
                ...
                Color dustColor = Color.Lerp(Color.Purple, Color.DeepPink, Main.rand.NextFloat() * 0.3f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            lightingColor = Utils.Remap(lightingColor + 255, 0.2f, 1f, 0f, 1f);

            Color backDarkColor = new Color(204, 56, 132); // Original Excalibur color: Color(180, 160, 60)
            Color middleMediumColor = new Color(121, 31, 70); // Original Excalibur color: Color(255, 255, 80)
            Color frontLightColor = new Color(35, 14, 64); // Original Excalibur color: Color(255, 240, 150)
