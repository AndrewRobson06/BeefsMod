...
{
    public class ScarabiteJavelinProjectile : ModProjectile
    {
        ...
        private void NormalAI()
        {
            ...
            {
                Dust dust = Dust.NewDustDirect(Projectile.position, Projectile.height, Projectile.width, DustID.BoneTorch, Projectile.velocity.X * .2f, Projectile.velocity.Y * .2f, 200, Scale: 1.2f);
                dust.velocity += Projectile.velocity * 0.3f;
                dust.velocity *= 0.2f;
            }
            if (Main.rand.NextBool(4))
            {
                Dust dust = Dust.NewDustDirect(Projectile.position, Projectile.height, Projectile.width, DustID.BoneTorch,
                    0, 0, 254, Scale: 0.3f);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                // Create a new dust
                Dust dust = Dust.NewDustDirect(usePos, Projectile.width, Projectile.height, DustID.BoneTorch);
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                {
                    item = Item.NewItem(Projectile.GetSource_DropAsItem(), Projectile.getRect(), ModContent.ItemType<ScarabiteJavelin>());
                }
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            target.AddBuff(ModContent.BuffType<Buffs.ScarabiteJavelinBuff>(), 900);
